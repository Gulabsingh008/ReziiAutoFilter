...
auth_channel = environ.get('AUTH_CHANNEL', '-1002152404910') #Channel / Group Id for force sub ( make sure bot is admin )
...
BOT_NAME = environ.get("BOT_NAME", "ʀᴇᴢɪɪ sᴇᴀʀᴄʜ ʙᴏᴛ")
BOT_ID = environ.get("BOT_ID", "7234362865")
